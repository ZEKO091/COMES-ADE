      ...
      <div class="app-body" id="app-body">
        <aside class="sidebar" aria-label="Navegación principal">
          ...
          <div class="sidebar-footer">
            ...
            <div class="sidebar-version"><span>COMESADE</span><span id="app-version-label">1.22.0</span></div>
          </div>
