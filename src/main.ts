      ...
      <div class="app-body" id="app-body">
        <aside class="sidebar" aria-label="Navegación principal">
          ...
          <div class="sidebar-footer">
            ...
            <div class="sidebar-version"><span>COMESADE</span><span id="app-version-label">0.1.3</span></div>
          </div>
